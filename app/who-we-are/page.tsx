    ...
    return (
        <div className="font-kumbh relative pt-16 md:pt-20">
            ...
            <div className="relative z-10">
                ...
                {/* ── Achievements ── */}
                <section id="our-achievements" className="py-16 md:py-24 bg-white/[0.03]">
                    <div className="max-w-6xl mx-auto px-6 sm:px-10">
                        <SectionHeader title="Achievements & Celebrations" />

                        <div className="mt-10 md:mt-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                            {Array.from({ length: 6 }).map((_, i) => (
                                <div
                                    key={i}
                                    className="w-full aspect-[4/3] rounded-2xl border border-white/[0.08] bg-white/[0.04] flex items-center justify-center text-white/20 text-sm font-medium italic"
                                >
...
function SectionHeader({
    ...
    return (
        <div className="max-w-2xl">
            <p className="text-[11px] font-semibold tracking-[.14em] uppercase text-[#c42b47]/70 mb-3">
                Bindzo 8
            </p>
...
function IndustryPill({ title, image }: IndustryPillProps) {
    return (
        <div className="group flex items-center gap-2.5 px-4 py-2.5 rounded-full border border-white/[0.12] bg-white/[0.05] transition-all duration-300 hover:border-[#c42b47]/40 hover:bg-[#c42b47]/[0.08] cursor-default">
            ...
            <span className="text-[13px] font-medium text-white/70 group-hover:text-white transition-colors duration-300 whitespace-nowrap">
                {title}
            </span>
        </div>
    );
...
//     },
//     {
//         image: "/who_we_are/who_we_work_with/publication.png", // ⚠️ if not present, update filename
//         title: "Media & Publishing",
//     },
// ];
...
//                         <h2 className="text-3xl md:text-5xl font-bold mb-6 text-[#c42b47] text-center tracking-tight">
//                             Why Choose Us
//                         </h2>
...
//                     <div className="max-w-5xl mx-auto px-6 sm:px-8 text-[#c42b47]">
...
//             <h3 className="w-full text-center text-xs md:text-base font-bold leading-tight text-[#d3325c] px-2">
//                 {title}
//             </h3>
//         </article>
//     );
