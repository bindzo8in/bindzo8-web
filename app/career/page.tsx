...
export default function Home() {
  return (
    <main className="min-h-screen bg-linear-to-br from-pink-50 via-white to-blue-50 font-kumbh pt-20 md:pt-24">
      {/* Hero Section */}
      <section className="max-w-7xl mx-auto px-6 text-center pt-12 mb-12 md:mb-16">
        <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 tracking-tight">
          Join Our <span className="text-[#c42b47]">Creative Team</span>
        </h1>
