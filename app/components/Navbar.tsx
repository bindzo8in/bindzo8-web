...
export default function Navbar() {
  ...
  return (
    <nav className="w-full fixed top-0 z-[100] bg-[#e4dfd9] shadow-sm border-b border-black/5">
              ...
              <li key={link.label} className="flex-shrink-0">
                <Link
                  ...
                  className={cn(
                    ...
                    isActive ? "text-[#df803b] font-bold" : "text-[#222222] hover:text-[#df803b] font-medium"
                  )}
                >
                  {link.label}
                  <span className={cn(
