...
function getServiceMessage(service: string) {
    if (!service || service === "General Enquiry") {
        return "Hi Bindzo 8 team, I would like to get a quote for your services. Please share the details with me.";
    }

    return `Hi Bindzo 8 team, I would like to get a quote for ${service}. Please share the pricing, timeline, and process details with me.`;
}
...
export default function QuoteModal({
    ...
    const message = defaultMessage || getServiceMessage(service);
    ...
    return (
      ...
      rounded-full bg-[#c42b47] text-white
      shadow-md transition-all duration-300
      hover:scale-105 hover:bg-[#cf244b]
      focus:outline-none focus:ring-2 focus:ring-[#c42b47]/30
      active:scale-95

      sm:right-5 sm:top-7 sm:size-10
    "
                    >
