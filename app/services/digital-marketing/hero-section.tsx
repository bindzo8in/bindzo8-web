...
const sources = [
  "/ourServices/wd/1.png",
  "/ourServices/wd/2.png",
  "/ourServices/wd/3.png",
  "/ourServices/wd/4.png",
  "/ourServices/wd/5.png",
  "/ourServices/wd/6.png",
  "/ourServices/wd/7.png",
  "/ourServices/wd/8.png",
  "/ourServices/wd/9.png",
  "/ourServices/wd/10.png",
];
...
<div className="absolute inset-0 w-full h-full">
  {sources.map((src, i) => (
    <div
      key={src}
      className={`hero-icon absolute ${positions[i]} w-[clamp(28px,2vw,48px)] h-[clamp(28px,2vw,48px)]`}
    >
      <Image
        src={src}
        alt={`icon-${i}`}
