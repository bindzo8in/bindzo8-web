...
const HeroSection = () => {
    ...
    useGSAP(() => {
        ...
        icons_array.forEach((icon) => {
            const startX = gsap.utils.random(-400, 400);
            const startY = gsap.utils.random(-300, 300);
            const midX = gsap.utils.random(-200, 200);
            const midY = gsap.utils.random(-150, 150);
    ...
    return (
        <section className='relative min-h-[calc(100vh-95px)] w-full  font-kumbh bg-black' ref={containerRef}>
            {/* icon container */}
            <div className='absolute inset-0 z-40 icon-container'>
                <Icon1 className="w-16 h-16 service-icon absolute top-[10%] left-[10%]" />

                <Icon2 className="w-16 h-16 service-icon absolute bottom-[10%] left-[10%]" />

                <Icon3 className="w-16 h-16 service-icon absolute bottom-[10%] right-[10%]" />

                <Icon4 className="w-16 h-16 service-icon absolute top-[50%] left-[20%]" />

                <Icon5 className="w-16 h-16 service-icon absolute top-[10%] right-[10%]" />

                <Icon6 className="w-16 h-16 service-icon absolute top-[30%] right-[25%]" />

                <Icon7 className="w-16 h-16 service-icon absolute top-[70%] right-[20%]" />

                <Icon8 className="w-16 h-16 service-icon absolute bottom-[20%] left-[35%]" />

                <Icon9 className="w-16 h-16 service-icon absolute top-[60%] left-[70%]" />
            </div>
