export const marketingPagesData = [
        ...
        features: [
            {
                ...
                description:
                    "Crafted to reflect your brand identity, engage visitors, and convert them into customers.",
            },
            {
                title: "Fully responsive & mobile-optimized",
                description:
                    "Your site looks perfect and functions smoothly on all devices — phones, tablets, and desktops.",
            },
            {
                title: "Fast, secure, and SEO-ready architecture",
                description:
                    "Optimized code, secure frameworks, and search-friendly structure for better rankings and safer browsing.",
            },
            {
                title: "Custom-built layouts and UI/UX",
                description:
                    "Unique designs tailored to your goals, ensuring smooth navigation and a premium user experience.",
            },
            {
                title: "Advanced features & integrations",
                description:
                    "E-commerce, booking systems, dashboards, chat systems, payment gateways, and more as per your needs.",
            },
            {
                title: "High-performance speed optimization",
                description:
                    "Lightning-fast loading times to boost engagement, reduce bounce rates, and improve conversions.",
            },
            {
                title: "Easy content management",
                description:
                    "CMS-based websites (WordPress, custom admin panels, etc.) so you can update content anytime.",
            },
        ],
    },
    {
    ...
    },
    {
        ...
        features: [
            {
                title: "Custom-built mobile apps for every industry",
                description:
                    "Designed to meet your business goals with seamless functionality and user-focused features.",
            },
            {
                title: "Smooth, intuitive UI/UX design",
                description:
                    "Beautiful interfaces and effortless navigation to deliver an engaging user experience.",
            },
            {
                title: "Scalable architecture for long-term growth",
                description:
                    "Apps engineered to handle increasing users, new features, and business expansion effortlessly.",
            },
            {
                title: "Secure and robust performance",
                description:
                    "Advanced encryption, secure APIs, and optimized coding to protect data and ensure stability.",
            },
            {
                title: "Feature-rich integrations",
                description:
                    "Payment gateways, location services, push notifications, chat systems, dashboards, and more.",
            },
            {
                title: "Optimized for speed & efficiency",
                description:
                    "Fast loading, responsive screens, and low battery consumption for a superior user experience.",
            },
            {
                title: "App Store & Play Store deployment",
                description:
                    "End-to-end support, including store compliance, publishing, approvals, and updates.",
            },
            {
                title: "Continuous maintenance & upgrades",
                description:
                    "Regular updates, bug fixing, feature enhancements, and performance improvements.",
            },
        ],
    },
    {
  ...
  features: [
...
},
    {
        ...
        features: [
            {
                title: "Custom-built software tailored to your workflow",
                description:
                    "Designed to automate tasks and solve real business challenges.",
            },
            {
                title: "Fast, secure, and stable architecture",
                description:
                    "Developed using modern technologies to ensure high performance and data safety.",
            },
            {
                title: "User-friendly design and smooth experience",
                description:
                    "Simple interfaces that make operations easier for your team.",
            },
            {
                title: "Seamless integrations",
                description:
                    "Connects with ERPs, CRMs, billing systems, payment gateways, and more.",
            },
            {
                title: "Scalable for future expansion",
                description:
                    "Easily add new modules or features as your business grows.",
            },
            {
                title: "Cross-platform compatibility",
                description:
                    "Software built to work across web, desktop, and mobile environments.",
            },
            {
                title: "Reliable support and continuous updates",
                description:
                    "Regular improvements, bug fixes, and long-term maintenance.",
            },
        ],
    },
    {
        ...
        features: [
            {
                title: "Result-driven online marketing strategies",
                description:
                    "Focused on increasing visibility, engagement, and customer conversion.",
            },
            {
                title: "Targeted ads for maximum ROI",
                description:
                    "Google, Meta, and multi-platform campaigns optimized for high returns.",
            },
            {
                title: "Brand growth across all digital channels",
                description:
                    "Social media, SEO, content, and ads working together to strengthen your brand.",
            },
            {
                title: "Data-backed campaign optimization",
                description:
                    "Every strategy refined using analytics, audience insights, and performance tracking.",
            },
            {
                title: "Creative content creation",
                description:
                    "High-quality posts, visuals, and ad creatives designed to attract and convert.",
            },
            {
                title: "Lead generation & sales acceleration",
                description:
                    "Smart funnels and automation to bring in qualified leads and boost revenue.",
            },
            {
                title: "Continuous monitoring & improvement",
                description:
                    "Real-time adjustments to keep your campaigns performing at their best.",
            },
        ],
    },
    {
