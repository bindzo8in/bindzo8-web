        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-4">
              {['Home', 'About', 'Services', 'Products', 'Career', 'Contact'].map(link => (
                <li key={link}>
                  <Link href="#" className="text-[14px] text-gray-600 font-medium hover:text-[#d6335a] transition-colors">{link}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="space-y-5 text-center sm:text-left">
            ...
            <div className="flex items-center sm:items-start justify-center sm:justify-start gap-3">
              ...
              <p className="text-[14px] text-gray-700 font-medium leading-relaxed">Coimbatore, India</p>
            </div>
            <div className="flex items-center sm:items-start justify-center sm:justify-start gap-3">
              <Phone className="w-4 h-4 mt-0.5 text-[#d6335a] shrink-0"/>
              <p className="text-[14px] text-gray-700 font-medium">+91 98843 44503</p>
            </div>
            <div className="flex items-center sm:items-start justify-center sm:justify-start gap-3">
              <Mail className="w-4 h-4 mt-0.5 text-[#d6335a] shrink-0" />
              <div className="text-[14px] text-gray-700 font-medium space-y-1 break-all">
