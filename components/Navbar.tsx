...
export default function Navbar() {
  ...
  return (
    <nav className="w-full fixed top-0 z-999999 bg-[#e4dfd9]">
      <div className="max-w-[1600px] mx-auto flex items-center justify-between px-8 lg:px-12 h-[95px] font-kumbh">
        {/* Logo */}
        <Link href="/" className="flex-shrink-0 w-48 xl:w-64">
          <img src="/logo.png" alt="Bindzo 8 Logo" className="h-[60px] object-contain" />
        </Link>
